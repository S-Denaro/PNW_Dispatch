...
def SysCost(model):
    ...
    return fixed + coal1 + coal2 + coal3 + gas1_5 + gas2_5 + gas3_5 + oil1 + oil2 + oil3 + psh1 + psh2 + psh3 + slack1 + slack2 + slack3 + starts + exchange
...
def Zone5_Balance(model,i):
    ...
    imports = sum(model.flow[s,'PNW',i] for s in model.sources) + model.PNWH_minflow[i] + model.P66I_minflow[i] + model.P65I_minflow[i] + model.P8I_minflow[i] + model.P14I_minflow[i] + model.P3I_minflow[i] + model.mwh_1['P66I',i] + model.mwh_2['P66I',i] + model.mwh_3['P66I',i] + model.mwh_1['P65I',i] + model.mwh_2['P65I',i] + model.mwh_3['P65I',i] + model.mwh_1['P3I',i] + model.mwh_2['P3I',i] + model.mwh_3['P3I',i] + model.mwh_1['P8I',i] + model.mwh_2['P8I',i] + model.mwh_3['P8I',i] + model.mwh_1['P14I',i] + model.mwh_2['P14I',i] + model.mwh_3['P14I',i] + model.mwh_1['PNWH',i] + model.mwh_2['PNWH',i] + model.mwh_3['PNWH',i]
    exports = sum(model.flow['PNW',k,i] for k in model.sinks) + model.HorizonPath66_exports[i] + model.HorizonPath65_exports[i] + model.HorizonPath8_exports[i] + model.HorizonPath3_exports[i] + model.HorizonPath14_exports[i]
...
def HydroC1(model,i):
    ...
    return m1 + m2 + m3 <= model.HorizonPNWH_hydro[1]
...
def P65minC(model,i):
    return model.P65_minflow[i] <= model.HorizonPath65_minflow[i]
